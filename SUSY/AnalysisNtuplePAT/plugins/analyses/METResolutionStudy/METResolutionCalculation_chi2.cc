...
{   
  ...
  output_filename = input_filename+"_chi2_optimized";
  ...
  ///125-67-58
   ...
   for(int aii=0;aii<59;aii++){    
     ...
     if(aii>1&&aii<58){
       ...
       h_type2calomet_x_v[aii]->Fit("myfit0","EMIRq","",-width,width);
       
       width = 2*(myfit0->GetParameter(2));
       TF1 *myfit1 = new TF1("myfit1","gaus",-width,width);
       h_type2calomet_x_v[aii]->Fit("myfit1","EMIRq","",-width,width);
     ...
     if(aii>1&&aii<58){
       ...
       TF1 *myfit0 = new TF1("myfit0","gaus",-width,width);
       h_pfmet_x_v[aii]->Fit("myfit0","EMIRq","",-width,width);

       width = 2*(myfit0->GetParameter(2));
       TF1 *myfit1 = new TF1("myfit1","gaus",-width,width);
       h_pfmet_x_v[aii]->Fit("myfit1","EMIRq","",-width,width);
     ...
     if(aii>1&&aii<58){
       ...
       TF1 *myfit0 = new TF1("myfit0","gaus",-width,width);
       h_tcmet_x_v[aii]->Fit("myfit0","EMIRq","",-width,width);

       width = 2*(myfit0->GetParameter(2));
       TF1 *myfit1 = new TF1("myfit1","gaus",-width,width);
       h_tcmet_x_v[aii]->Fit("myfit1","EMIRq","",-width,width);
     ...
     if(aii>1&&aii<58){
       ...
       TF1 *myfit0 = new TF1("myfit0","gaus",-width,width);
       h_type1pfmet_x_v[aii]->Fit("myfit0","EMIRq","",-width,width);

       width = 2*(myfit0->GetParameter(2));
       TF1 *myfit1 = new TF1("myfit1","gaus",-width,width);
       h_type1pfmet_x_v[aii]->Fit("myfit1","EMIRq","",-width,width);
     ...
     if(aii>1&&aii<58){
       ...
       TF1 *myfit0 = new TF1("myfit0","gaus",-width,width);
       h_tcmet_x_v_reco[aii]->Fit("myfit0","EMIRq","",-width,width);

       width = 2*(myfit0->GetParameter(2));
       TF1 *myfit1 = new TF1("myfit1","gaus",-width,width);
       h_tcmet_x_v_reco[aii]->Fit("myfit1","EMIRq","",-width,width);
     ...
     if(aii>1&&aii<58){
       ...
       TF1 *myfit0 = new TF1("myfit0","gaus",-width,width);
       h_pfmet_x_v_reco[aii]->Fit("myfit0","EMIRq","",-width,width);

       width = 2*(myfit0->GetParameter(2));
       TF1 *myfit1 = new TF1("myfit1","gaus",-width,width);
       h_pfmet_x_v_reco[aii]->Fit("myfit1","EMIRq","",-width,width);
     ...
     if(aii>1&&aii<58){
       ...
       TF1 *myfit0 = new TF1("myfit0","gaus",-width,width);
       h_type2calomet_x_v_reco[aii]->Fit("myfit0","EMIRq","",-width,width);

       width = 2*(myfit0->GetParameter(2));
       TF1 *myfit1 = new TF1("myfit1","gaus",-width,width);
       h_type2calomet_x_v_reco[aii]->Fit("myfit1","EMIRq","",-width,width);
     ...
     if(aii>1&&aii<58){
       ...
       TF1 *myfit0 = new TF1("myfit0","gaus",-width,width);
       h_type1pfmet_x_v_reco[aii]->Fit("myfit0","EMIRq","",-width,width);

       width = 2*(myfit0->GetParameter(2));
       TF1 *myfit1 = new TF1("myfit1","gaus",-width,width);
       h_type1pfmet_x_v_reco[aii]->Fit("myfit1","EMIRq","",-width,width);
     ...
     if(aii>1&&aii<58){
       ...
       TF1 *myfit0 = new TF1("myfit0","gaus",-width,width);
       h_tcmet_x_v_RescalingMETALSO[aii]->Fit("myfit0","EMIRq","",-width,width);
       ...
       width = 2*(myfit0->GetParameter(2));
       TF1 *myfit1 = new TF1("myfit1","gaus",-width,width);
       h_tcmet_x_v_RescalingMETALSO[aii]->Fit("myfit1","EMIRq","",-width,width);
     ...
     if(aii>1&&aii<58){
       ...
       TF1 *myfit0 = new TF1("myfit0","gaus",-width,width);
       h_pfmet_x_v_RescalingMETALSO[aii]->Fit("myfit0","EMIRq","",-width,width);
       ...
       width = 2*(myfit0->GetParameter(2));
       TF1 *myfit1 = new TF1("myfit1","gaus",-width,width);
       h_pfmet_x_v_RescalingMETALSO[aii]->Fit("myfit1","EMIRq","",-width,width);
     ...
     if(aii>1&&aii<58){
       ...
       TF1 *myfit0 = new TF1("myfit0","gaus",-width,width);
       h_type2calomet_x_v_RescalingMETALSO[aii]->Fit("myfit0","EMIRq","",-width,width);
       ...
       width = 2*(myfit0->GetParameter(2));
       TF1 *myfit1 = new TF1("myfit1","gaus",-width,width);
       h_type2calomet_x_v_RescalingMETALSO[aii]->Fit("myfit1","EMIRq","",-width,width);
     ...
     if(aii>1&&aii<58){
       ...
       TF1 *myfit0 = new TF1("myfit0","gaus",-width,width);
       h_type1pfmet_x_v_RescalingMETALSO[aii]->Fit("myfit0","EMIRq","",-width,width);
       ...
       width = 2*(myfit0->GetParameter(2));
       TF1 *myfit1 = new TF1("myfit1","gaus",-width,width);
       h_type1pfmet_x_v_RescalingMETALSO[aii]->Fit("myfit1","EMIRq","",-width,width);
     ...
     if(aii>1&&aii<58){
       ...
       TF1 *myfit0 = new TF1("myfit0","gaus",-width,width);
       h_tcmet_x_v_RescalingMETALSO_vs_pf[aii]->Fit("myfit0","EMIRq","",-width,width);
       ...
       width = 2*(myfit0->GetParameter(2));
       TF1 *myfit1 = new TF1("myfit1","gaus",-width,width);
       h_tcmet_x_v_RescalingMETALSO_vs_pf[aii]->Fit("myfit1","EMIRq","",-width,width);
     ...
     if(aii>1&&aii<58){
       ...
       TF1 *myfit0 = new TF1("myfit0","gaus",-width,width);
       h_type2calomet_x_v_RescalingMETALSO_vs_pf[aii]->Fit("myfit0","EMIRq","",-width,width);
       ...
       width = 2*(myfit0->GetParameter(2));
       TF1 *myfit1 = new TF1("myfit1","gaus",-width,width);
       h_type2calomet_x_v_RescalingMETALSO_vs_pf[aii]->Fit("myfit1","EMIRq","",-width,width);
	 ...
	 TF1 *myfit0 = new TF1("myfit0","gaus",-width,width);
	 h_tcmet_x_v_RescalingMETALSO_vs_type2[aii]->Fit("myfit0","EMIRq","",-width,width);
	 ...
	 width = 2*(myfit0->GetParameter(2));
	 TF1 *myfit1 = new TF1("myfit1","gaus",-width,width);
	 h_tcmet_x_v_RescalingMETALSO_vs_type2[aii]->Fit("myfit1","EMIRq","",-width,width);
	 ...
	 TF1 *myfit0 = new TF1("myfit0","gaus",-width,width);
	 h_pfmet_x_v_RescalingMETALSO_vs_type2[aii]->Fit("myfit0","EMIRq","",-width,width);
	 ...
	 width = 2*(myfit0->GetParameter(2));
	 TF1 *myfit1 = new TF1("myfit1","gaus",-width,width);
	 h_pfmet_x_v_RescalingMETALSO_vs_type2[aii]->Fit("myfit1","EMIRq","",-width,width);
	 ...
	 TF1 *myfit0 = new TF1("myfit0","gaus",-width,width);
	 h_type1pfmet_x_v_RescalingMETALSO_vs_type2[aii]->Fit("myfit0","EMIRq","",-width,width);
	 ...
	 width = 2*(myfit0->GetParameter(2));
	 TF1 *myfit1 = new TF1("myfit1","gaus",-width,width);
	 h_type1pfmet_x_v_RescalingMETALSO_vs_type2[aii]->Fit("myfit1","EMIRq","",-width,width);
     ...
     if(aii>1&&aii<58){
       ...
       TF1 *myfit0 = new TF1("myfit0","gaus",-width,width);
       h_tcmet_x_v_RescalingMETALSO_vs_type1pf[aii]->Fit("myfit0","EMIRq","",-width,width);

       width = 2*(myfit0->GetParameter(2));
       TF1 *myfit1 = new TF1("myfit1","gaus",-width,width);
       h_tcmet_x_v_RescalingMETALSO_vs_type1pf[aii]->Fit("myfit1","EMIRq","",-width,width);
     ...
     if(aii>1&&aii<58){
       ...
       TF1 *myfit0 = new TF1("myfit0","gaus",-width,width);
       h_type2calomet_x_v_RescalingMETALSO_vs_type1pf[aii]->Fit("myfit0","EMIRq","",-width,width);

       width = 2*(myfit0->GetParameter(2));
       TF1 *myfit1 = new TF1("myfit1","gaus",-width,width);
       h_type2calomet_x_v_RescalingMETALSO_vs_type1pf[aii]->Fit("myfit1","EMIRq","",-width,width);
	 ...
	 TF1 *myfit0 = new TF1("myfit0","gaus",-width,width);
	 h_tcmet_x_v_RescalingMETALSO_vs_uncal_type2[aii]->Fit("myfit0","EMIRq","",-width,width);
	 
	 width = 2*(myfit0->GetParameter(2));
	 TF1 *myfit1 = new TF1("myfit1","gaus",-width,width);
	 h_tcmet_x_v_RescalingMETALSO_vs_uncal_type2[aii]->Fit("myfit1","EMIRq","",-width,width);
	 ...
	 TF1 *myfit0 = new TF1("myfit0","gaus",-width,width);
	 h_type2calomet_x_v_RescalingMETALSO_vs_uncal_type2[aii]->Fit("myfit0","EMIRq","",-width,width);
	 
	 width = 2*(myfit0->GetParameter(2));
	 TF1 *myfit1 = new TF1("myfit1","gaus",-width,width);
	 h_type2calomet_x_v_RescalingMETALSO_vs_uncal_type2[aii]->Fit("myfit1","EMIRq","",-width,width);
	 ...
	 TF1 *myfit0 = new TF1("myfit0","gaus",-width,width);
	 h_pfmet_x_v_RescalingMETALSO_vs_uncal_type2[aii]->Fit("myfit0","EMIRq","",-width,width);
	 
	 width = 2*(myfit0->GetParameter(2));
	 TF1 *myfit1 = new TF1("myfit1","gaus",-width,width);
	 h_pfmet_x_v_RescalingMETALSO_vs_uncal_type2[aii]->Fit("myfit1","EMIRq","",-width,width);
	 ...
	 TF1 *myfit0 = new TF1("myfit0","gaus",-width,width);
	 h_type1pfmet_x_v_RescalingMETALSO_vs_uncal_type2[aii]->Fit("myfit0","EMIRq","",-width,width);
	 
	 width = 2*(myfit0->GetParameter(2));
	 TF1 *myfit1 = new TF1("myfit1","gaus",-width,width);
	 h_type1pfmet_x_v_RescalingMETALSO_vs_uncal_type2[aii]->Fit("myfit1","EMIRq","",-width,width);
     ...
     if(aii>1&&aii<58){
       ...
       TF1 *myfit0 = new TF1("myfit0","gaus",-width,width);
       h_tcmet_x_v_RescalingMETALSO_vs_uncal_pf[aii]->Fit("myfit0","EMIRq","",-width,width);

       width = 2*(myfit0->GetParameter(2));
       TF1 *myfit1 = new TF1("myfit1","gaus",-width,width);
       h_tcmet_x_v_RescalingMETALSO_vs_uncal_pf[aii]->Fit("myfit1","EMIRq","",-width,width);
     ...
     if(aii>1&&aii<58){
       ...
       TF1 *myfit0 = new TF1("myfit0","gaus",-width,width);
       h_type2calomet_x_v_RescalingMETALSO_vs_uncal_pf[aii]->Fit("myfit0","EMIRq","",-width,width);

       width = 2*(myfit0->GetParameter(2));
       TF1 *myfit1 = new TF1("myfit1","gaus",-width,width);
       h_type2calomet_x_v_RescalingMETALSO_vs_uncal_pf[aii]->Fit("myfit1","EMIRq","",-width,width);
     ...
     if(aii>1&&aii<58){
       ...
       TF1 *myfit0 = new TF1("myfit0","gaus",-width,width);
       h_pfmet_x_v_RescalingMETALSO_vs_uncal_pf[aii]->Fit("myfit0","EMIRq","",-width,width);

       width = 2*(myfit0->GetParameter(2));
       TF1 *myfit1 = new TF1("myfit1","gaus",-width,width);
       h_pfmet_x_v_RescalingMETALSO_vs_uncal_pf[aii]->Fit("myfit1","EMIRq","",-width,width);
     ...
     if(aii>1&&aii<58){
       ...
       TF1 *myfit0 = new TF1("myfit0","gaus",-width,width);
       h_tcmet_x_v_RescalingMETALSO_vs_uncal_type1pf[aii]->Fit("myfit0","EMIRq","",-width,width);

       width = 2*(myfit0->GetParameter(2));
       TF1 *myfit1 = new TF1("myfit1","gaus",-width,width);
       h_tcmet_x_v_RescalingMETALSO_vs_uncal_type1pf[aii]->Fit("myfit1","EMIRq","",-width,width);
     ...
     if(aii>1&&aii<58){
       ...
       TF1 *myfit0 = new TF1("myfit0","gaus",-width,width);
       h_type2calomet_x_v_RescalingMETALSO_vs_uncal_type1pf[aii]->Fit("myfit0","EMIRq","",-width,width);

       width = 2*(myfit0->GetParameter(2));
       TF1 *myfit1 = new TF1("myfit1","gaus",-width,width);
       h_type2calomet_x_v_RescalingMETALSO_vs_uncal_type1pf[aii]->Fit("myfit1","EMIRq","",-width,width);
     ...
     if(aii>1&&aii<58){
       ...
       TF1 *myfit0 = new TF1("myfit0","gaus",-width,width);
       h_type1pfmet_x_v_RescalingMETALSO_vs_uncal_type1pf[aii]->Fit("myfit0","EMIRq","",-width,width);

       width = 2*(myfit0->GetParameter(2));
       TF1 *myfit1 = new TF1("myfit1","gaus",-width,width);
       h_type1pfmet_x_v_RescalingMETALSO_vs_uncal_type1pf[aii]->Fit("myfit1","EMIRq","",-width,width);
