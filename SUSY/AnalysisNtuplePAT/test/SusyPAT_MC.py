...
options.register ('patout',
    'PATtuple_V9_MC_TTBar.root', # default value
    VarParsing.VarParsing.multiplicity.singleton, # singleton or list
    VarParsing.VarParsing.varType.string,          # string, int, or float
    "Name of PATtuple file"
)
options.register ('outputfile',
    'SUSYPAT_MC_TTBar.root', # default value
    VarParsing.VarParsing.multiplicity.singleton, # singleton or list
    VarParsing.VarParsing.varType.string,          # string, int, or float
    "Name of PATtuple file"
)
options.register ('globtag',
    'START38_V14', # default value
    VarParsing.VarParsing.multiplicity.singleton, # singleton or list
    VarParsing.VarParsing.varType.string,          # string, int, or float
    "Name of GlobalTag"
)
...
process.source = cms.Source("PoolSource",
    #fileNames = cms.untracked.vstring('/store/relval/CMSSW_3_8_0_pre8/RelValTTbar/GEN-SIM-RECO/START38_V6-v1/0004/847D00B0-608E-DF11-A37D-003048678FA0.root'),
    fileNames = cms.untracked.vstring('/store/mc/Summer10/MinBias_7TeV-pythia8/GEN-SIM-RECODEBUG/START36_V10_SP10-v1/0001/60963867-7374-DF11-8365-00237DA1CD7E.root'),
    #fileNames = cms.untracked.vstring('/store/mc/Spring10/MinBias_7TeV-pythia8/GEN-SIM-RECO/START3X_V26B-v1/0001/5E076339-1A5D-DF11-A309-0018FE283D76.root'),
...
process.patJetsAK5Track = cms.EDProducer("PATJetProducer",
    ...
    partonJetSource = cms.InputTag("NOT_IMPLEMENTED"),
    addGenPartonMatch = cms.bool(True),
    JetPartonMapSource = cms.InputTag("patJetFlavourAssociationAK5Track"),
    resolutions = cms.PSet(

    ),
    genPartonMatch = cms.InputTag("patJetPartonMatchAK5Track"),
    addTagInfos = cms.bool(False),
    addPartonJetMatch = cms.bool(False),
    embedGenPartonMatch = cms.bool(True),
    efficiencies = cms.PSet(
    ...
    genJetMatch = cms.InputTag("patJetGenJetMatchAK5Track"),
    userData = cms.PSet(
        userCands = cms.PSet(
            src = cms.VInputTag("")
        ),
...
process.photonTriggerMatchHLTPhoton30PF = cms.EDProducer("PATTriggerMatcherDRDPtLessByR",
    src = cms.InputTag("selectedPatPhotonsPF"),
    maxDPtRel = cms.double(0.5),
    andOr = cms.bool(False),
    filterIdsEnum = cms.vstring('TriggerPhoton'),
...
process.triggerMatchedPatPhotonsPF = cms.EDProducer("PATTriggerMatchPhotonEmbedder",
    matches = cms.VInputTag("photonTriggerMatchHLTPhoton30PF"),
    src = cms.InputTag("selectedPatPhotonsPF")
)
...
process.cleanPatCandidateSummary = cms.EDAnalyzer("CandidateSummaryTable",
    ...
    candidates = cms.VInputTag(cms.InputTag("cleanPatElectrons"), cms.InputTag("cleanPatMuons"), cms.InputTag("cleanPatTaus"), cms.InputTag("cleanPatPhotons"), cms.InputTag("cleanPatJetsAK5Calo"), 
        cms.InputTag("cleanPatJetsAK5JPT"), cms.InputTag("cleanPatJetsAK5Track"), cms.InputTag("cleanPatJetsAK5PF"))
)


process.cleanPatCandidateSummaryPF = cms.EDAnalyzer("CandidateSummaryTable",
    candidates = cms.VInputTag(cms.InputTag("cleanPatElectronsPF"), cms.InputTag("cleanPatMuonsPF"), cms.InputTag("cleanPatTausPF"), cms.InputTag("cleanPatJetsPF")),
    logName = cms.untracked.string('cleanPatCandidates|PATSummaryTables')
)
...
process.patCandidateSummary = cms.EDAnalyzer("CandidateSummaryTable",
    ...
    candidates = cms.VInputTag(cms.InputTag("patElectrons"), cms.InputTag("patMuons"), cms.InputTag("patTaus"), cms.InputTag("patPhotons"), cms.InputTag("patJets"), 
        cms.InputTag("patMETsTC"), cms.InputTag("patMETsAK5Calo"), cms.InputTag("patMHTsAK5Calo"), cms.InputTag("patJetsAK5JPT"), cms.InputTag("patJetsAK5Track"), 
        cms.InputTag("patJetsAK5PF"))
)


process.patCandidateSummaryPF = cms.EDAnalyzer("CandidateSummaryTable",
    candidates = cms.VInputTag(cms.InputTag("patElectronsPF"), cms.InputTag("patMuonsPF"), cms.InputTag("patTausPF"), cms.InputTag("patJetsPF"), cms.InputTag("patMETsPF"), 
...
process.selectedPatCandidateSummary = cms.EDAnalyzer("CandidateSummaryTable",
    ...
    candidates = cms.VInputTag(cms.InputTag("selectedPatElectrons"), cms.InputTag("selectedPatMuons"), cms.InputTag("selectedPatTaus"), cms.InputTag("selectedPatPhotons"), cms.InputTag("selectedPatJets"), 
        cms.InputTag("selectedPatJetsAK5JPT"), cms.InputTag("selectedPatJetsAK5Track"), cms.InputTag("selectedPatJetsAK5PF"))
)


process.selectedPatCandidateSummaryPF = cms.EDAnalyzer("CandidateSummaryTable",
    candidates = cms.VInputTag(cms.InputTag("selectedPatElectronsPF"), cms.InputTag("selectedPatMuonsPF"), cms.InputTag("selectedPatTausPF"), cms.InputTag("selectedPatJetsPF"), cms.InputTag("selectedPatPFParticles")),
    logName = cms.untracked.string('selectedPatCanddiates|PATSummaryTables')
)
...
process.patJetFlavourId = cms.Sequence(process.patJetPartons*process.patJetPartonAssociation*process.patJetPartonAssociationAK5PF*process.patJetPartonAssociationAK5Track*process.patJetPartonAssociationAK5JPT*process.patJetFlavourAssociation*process.patJetFlavourAssociationAK5PF*process.patJetFlavourAssociationAK5Track*process.patJetFlavourAssociationAK5JPT)
...
process.patTriggerMatcherPF = cms.Sequence(process.electronTriggerMatchHLTEle15LWL1RPF+process.muonTriggerMatchHLTMu9PF+process.photonTriggerMatchHLTPhoton30PF+process.jetTriggerMatchHLTJet15UPF+process.jetTriggerMatchHLTJet30UPF+process.jetTriggerMatchHLTJet50UPF+process.tauTriggerMatchHLTJet15UPF+process.tauTriggerMatchHLTJet30UPF+process.tauTriggerMatchHLTJet50UPF)
...
process.makePatPhotonsPF = cms.Sequence(process.photonMatchPF+process.patPhotonsPF)
...
process.patTriggerMatcher = cms.Sequence(process.electronTriggerMatchHLTEle15LWL1R+process.muonTriggerMatchHLTMu9+process.photonTriggerMatchHLTPhoton30+process.jetTriggerMatchHLTJet15UAK5Calo+process.jetTriggerMatchHLTJet15UAK5JPT+process.jetTriggerMatchHLTJet15UAK5Track+process.jetTriggerMatchHLTJet15UAK5PF+process.jetTriggerMatchHLTJet30UAK5Calo+process.jetTriggerMatchHLTJet30UAK5JPT+process.jetTriggerMatchHLTJet30UAK5Track+process.jetTriggerMatchHLTJet30UAK5PF+process.jetTriggerMatchHLTJet50UAK5Calo+process.jetTriggerMatchHLTJet50UAK5JPT+process.jetTriggerMatchHLTJet50UAK5Track+process.jetTriggerMatchHLTJet50UAK5PF+process.tauTriggerMatchHLTJet15U+process.tauTriggerMatchHLTJet30U+process.tauTriggerMatchHLTJet50U)
...
process.cleanPatCandidates = cms.Sequence(process.cleanPatMuons*process.cleanPatElectrons*process.cleanPatPhotons*process.cleanPatTaus*process.cleanPatJetsAK5Calo*process.cleanPatJetsAK5PF*process.cleanPatJetsAK5Track*process.cleanPatJetsAK5JPT*process.cleanPatCandidateSummary)
...
process.selectedPatCandidates = cms.Sequence(process.selectedPatElectrons+process.selectedPatMuons+process.selectedPatTaus+process.selectedPatPhotons+process.selectedPatJets*process.selectedPatJetsAK5PF*process.selectedPatJetsAK5Track*process.selectedPatJetsAK5JPT+process.selectedPatCandidateSummary)


process.countPatCandidates = cms.Sequence(process.countPatElectrons+process.countPatMuons+process.countPatTaus+process.countPatLeptons+process.countPatPhotons+process.countPatJets*process.countPatJetsAK5PF*process.countPatJetsAK5Track*process.countPatJetsAK5JPT)
...
process.patTriggerSequencePF = cms.Sequence(process.patTrigger*process.patTriggerMatcherPF*process.patTriggerEvent+process.triggerMatchedPatElectronsPF+process.triggerMatchedPatMuonsPF+process.triggerMatchedPatPhotonsPF+process.triggerMatchedPatJetsPF+process.triggerMatchedPatTausPF)
...
process.makePatJetsPF = cms.Sequence(process.patJetCorrectionsPF+process.jetTracksAssociatorAtVertexPF+process.btaggingAOD+process.patJetChargePF+process.patJetPartonMatchPF+process.patJetGenJetMatchPF+process.patJetFlavourIdPF+process.patJetsPF)


process.makePatJets = cms.Sequence(process.patJetCorrections*(process.jetTracksAssociatorAtVertexAK5JPT+process.btaggingAK5JPT+(process.jetTracksAssociatorAtVertexAK5Track+process.btaggingAK5Track+(process.jetTracksAssociatorAtVertexAK5PF+process.btaggingAK5PF+process.patJetCharge*process.patJetChargeAK5PF)*process.patJetChargeAK5Track)*process.patJetChargeAK5JPT)*process.patJetPartonMatch*process.patJetPartonMatchAK5PF*process.patJetPartonMatchAK5Track*process.patJetPartonMatchAK5JPT*process.patJetGenJetMatch*process.patJetGenJetMatchAK5PF*process.patJetGenJetMatchAK5Track*process.patJetGenJetMatchAK5JPT*process.patJetFlavourId*process.patJets*process.patJetsAK5PF*process.patJetsAK5Track*process.patJetsAK5JPT)
...
process.patCandidatesPF = cms.Sequence(process.makePatElectronsPF+process.makePatMuonsPF+process.makePatTausPF+process.makePatPhotonsPF+process.makePatJetsPF+process.makePatMETsPF+process.patPFParticles+process.patCandidateSummaryPF)


process.patDefaultSequencePF = cms.Sequence(process.genForPF2PATSequence+process.patCandidatesPF+process.selectedPatCandidatesPF+process.countPatCandidatesPF+process.patTriggerSequencePF)
