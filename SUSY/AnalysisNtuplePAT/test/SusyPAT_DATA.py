...
options.register('outputfile',
    'SUSYPAT_DATA.root', # default value
    VarParsing.VarParsing.multiplicity.singleton, # singleton or list
    VarParsing.VarParsing.varType.string,          # string, int, or float
    "Name of config file"
)
options.register('globtag',
    'GR10_P_V11', # default value
    VarParsing.VarParsing.multiplicity.singleton, # singleton or list
    VarParsing.VarParsing.varType.string,          # string, int, or float
    "Name of GlobalTag"
)
options.register ('hltres',
    'HLT', # default value
    VarParsing.VarParsing.multiplicity.singleton, # singleton or list
    VarParsing.VarParsing.varType.string,          # string, int, or float
...
#print("cfgfilename:"+options.cfgfilename)
print("patout:"+options.patout)
print("globtag:"+options.globtag)
print("hltres:"+options.hltres)

process.source = cms.Source("PoolSource",
    fileNames = cms.untracked.vstring(
        '/store/data/Run2010B/Jet/RECO/PromptReco-v2/000/146/428/D6F2DB84-B5C6-DF11-85E0-001617C3B66C.root'
        #'/store/data/Run2010B/JetMETTauMonitor/RECO/PromptReco-v2/000/147/926/FE5B3CB4-3CD8-DF11-BA66-001617E30CC2.root',
        #'/store/data/Run2010B/JetMETTauMonitor/RECO/PromptReco-v2/000/147/926/FE506A4F-42D8-DF11-A5DB-0030487CBD0A.root',
        #'/store/data/Run2010B/JetMETTauMonitor/RECO/PromptReco-v2/000/147/926/DA406B8F-3AD8-DF11-BE37-0030487CD716.root',
        #'/store/data/Run2010B/JetMETTauMonitor/RECO/PromptReco-v2/000/147/926/B036F326-40D8-DF11-A675-001617C3B65A.root',
        #'/store/data/Run2010B/JetMETTauMonitor/RECO/PromptReco-v2/000/147/926/AE4F3C8B-3AD8-DF11-81B6-0030487C778E.root',
        #'/store/data/Run2010B/JetMETTauMonitor/RECO/PromptReco-v2/000/147/926/A86CB6FF-34D8-DF11-885D-000423D996C8.root',
        #'/store/data/Run2010B/JetMETTauMonitor/RECO/PromptReco-v2/000/147/926/A4442451-42D8-DF11-B966-0030487C778E.root',
        #'/store/data/Run2010B/JetMETTauMonitor/RECO/PromptReco-v2/000/147/926/90B26202-35D8-DF11-9B9E-001617C3B654.root',
        #'/store/data/Run2010B/JetMETTauMonitor/RECO/PromptReco-v2/000/147/926/7E9CA37F-3FD8-DF11-962E-0030487C7392.root',
        #'/store/data/Run2010B/JetMETTauMonitor/RECO/PromptReco-v2/000/147/926/7CF73AD6-39D8-DF11-AB9F-001617E30D52.root',
        #'/store/data/Run2010B/JetMETTauMonitor/RECO/PromptReco-v2/000/147/926/723816CE-3ED8-DF11-8D3B-0030487C778E.root',
        #'/store/data/Run2010B/JetMETTauMonitor/RECO/PromptReco-v2/000/147/926/587D1E8B-3AD8-DF11-85F2-0030487A18F2.root',
        #'/store/data/Run2010B/JetMETTauMonitor/RECO/PromptReco-v2/000/147/926/08D4CD96-41D8-DF11-A451-0030487C7392.root'
    ),
    duplicateCheckMode = cms.untracked.string('noDuplicateCheck'),
    #eventsToProcess = cms.untracked.VEventRange('146428:2515643')
)
...
process.cleanPatJetsIC5Calo = cms.EDProducer("PATJetCleaner",
    finalCut = cms.string(''),
...
process.combinedSecondaryVertexBJetTagsIC5Calo = cms.EDProducer("JetTagProducer",
    jetTagComputer = cms.string('combinedSecondaryVertex'),
    tagInfos = cms.VInputTag(cms.InputTag("impactParameterTagInfosIC5Calo"), cms.InputTag("secondaryVertexTagInfosIC5Calo"))
)
...
process.combinedSecondaryVertexMVABJetTagsIC5Calo = cms.EDProducer("JetTagProducer",
    jetTagComputer = cms.string('combinedSecondaryVertexMVA'),
    tagInfos = cms.VInputTag(cms.InputTag("impactParameterTagInfosIC5Calo"), cms.InputTag("secondaryVertexTagInfosIC5Calo"))
)
...
process.electronTriggerMatchHLTDoubleEle5SWL1R = cms.EDProducer("PATTriggerMatcherDRDPtLessByR",
    src = cms.InputTag("cleanPatElectrons"),
...
process.electronTriggerMatchHLTEle15LWL1R = cms.EDProducer("PATTriggerMatcherDRDPtLessByR",
    src = cms.InputTag("cleanPatElectrons"),
    maxDPtRel = cms.double(0.5),
    andOr = cms.bool(False),
    filterIdsEnum = cms.vstring('*'),
...
process.electronTriggerMatchHLTEle15LWL1RPF = cms.EDProducer("PATTriggerMatcherDRDPtLessByR",
    src = cms.InputTag("selectedPatElectronsPF"),
    maxDPtRel = cms.double(0.5),
    andOr = cms.bool(False),
    filterIdsEnum = cms.vstring('*'),
...
process.impactParameterTagInfosIC5Calo = cms.EDProducer("TrackIPProducer",
    maximumTransverseImpactParameter = cms.double(0.2),
    minimumNumberOfHits = cms.int32(8),
    minimumTransverseMomentum = cms.double(1.0),
    primaryVertex = cms.InputTag("offlinePrimaryVertices"),
    ...
    computeGhostTrack = cms.bool(True),
    ghostTrackPriorDeltaR = cms.double(0.03),
    jetTracks = cms.InputTag("jetTracksAssociatorAtVertexIC5Calo"),
    jetDirectionUsingGhostTrack = cms.bool(False),
    minimumNumberOfPixelHits = cms.int32(2),
    jetDirectionUsingTracks = cms.bool(False),
    computeProbabilities = cms.bool(True),
...
process.jetBProbabilityBJetTagsIC5Calo = cms.EDProducer("JetTagProducer",
    jetTagComputer = cms.string('jetBProbability'),
    tagInfos = cms.VInputTag(cms.InputTag("impactParameterTagInfosIC5Calo"))
)
...
process.jetProbabilityBJetTagsIC5Calo = cms.EDProducer("JetTagProducer",
    jetTagComputer = cms.string('jetProbability'),
    tagInfos = cms.VInputTag(cms.InputTag("impactParameterTagInfosIC5Calo"))
)
...
process.jetTracksAssociatorAtVertexIC5Calo = cms.EDProducer("JetTracksAssociatorAtVertex",
...
process.jetTriggerMatchHLTJet15UAK5Calo = cms.EDProducer("PATTriggerMatcherDRDPtLessByR",
...
process.jetTriggerMatchHLTJet15UAK5JPT = cms.EDProducer("PATTriggerMatcherDRDPtLessByR",
...
process.jetTriggerMatchHLTJet15UAK5PF = cms.EDProducer("PATTriggerMatcherDRDPtLessByR",
...
process.jetTriggerMatchHLTJet15UAK5Track = cms.EDProducer("PATTriggerMatcherDRDPtLessByR",
...
process.jetTriggerMatchHLTJet15UIC5Calo = cms.EDProducer("PATTriggerMatcherDRDPtLessByR",
...
process.jetTriggerMatchHLTJet15UPF = cms.EDProducer("PATTriggerMatcherDRDPtLessByR",
    src = cms.InputTag("selectedPatJetsPF"),
    maxDPtRel = cms.double(0.5),
    andOr = cms.bool(False),
    filterIdsEnum = cms.vstring('TriggerJet'),
...
process.jetTriggerMatchHLTJet30UAK5Calo = cms.EDProducer("PATTriggerMatcherDRDPtLessByR",
    src = cms.InputTag("cleanPatJetsAK5Calo"),
    maxDPtRel = cms.double(0.5),
    andOr = cms.bool(False),
    filterIdsEnum = cms.vstring('TriggerJet'),
...
process.jetTriggerMatchHLTJet30UAK5JPT = cms.EDProducer("PATTriggerMatcherDRDPtLessByR",
    src = cms.InputTag("cleanPatJetsAK5JPT"),
    maxDPtRel = cms.double(0.5),
    andOr = cms.bool(False),
    filterIdsEnum = cms.vstring('TriggerJet'),
...
process.jetTriggerMatchHLTJet30UAK5PF = cms.EDProducer("PATTriggerMatcherDRDPtLessByR",
    src = cms.InputTag("cleanPatJetsAK5PF"),
    maxDPtRel = cms.double(0.5),
    andOr = cms.bool(False),
    filterIdsEnum = cms.vstring('TriggerJet'),
...
process.jetTriggerMatchHLTJet30UAK5Track = cms.EDProducer("PATTriggerMatcherDRDPtLessByR",
    src = cms.InputTag("cleanPatJetsAK5Track"),
    maxDPtRel = cms.double(0.5),
    andOr = cms.bool(False),
    filterIdsEnum = cms.vstring('TriggerJet'),
...
process.jetTriggerMatchHLTJet30UIC5Calo = cms.EDProducer("PATTriggerMatcherDRDPtLessByR",
    src = cms.InputTag("cleanPatJetsIC5Calo"),
    maxDPtRel = cms.double(0.5),
    andOr = cms.bool(False),
    filterIdsEnum = cms.vstring('TriggerJet'),
...
process.jetTriggerMatchHLTJet30UPF = cms.EDProducer("PATTriggerMatcherDRDPtLessByR",
    src = cms.InputTag("selectedPatJetsPF"),
    maxDPtRel = cms.double(0.5),
    andOr = cms.bool(False),
    filterIdsEnum = cms.vstring('TriggerJet'),
...
process.jetTriggerMatchHLTJet50UAK5Calo = cms.EDProducer("PATTriggerMatcherDRDPtLessByR",
    src = cms.InputTag("cleanPatJetsAK5Calo"),
    maxDPtRel = cms.double(0.5),
    andOr = cms.bool(False),
    filterIdsEnum = cms.vstring('TriggerJet'),
...
process.jetTriggerMatchHLTJet50UAK5JPT = cms.EDProducer("PATTriggerMatcherDRDPtLessByR",
    src = cms.InputTag("cleanPatJetsAK5JPT"),
    maxDPtRel = cms.double(0.5),
    andOr = cms.bool(False),
    filterIdsEnum = cms.vstring('TriggerJet'),
...
process.jetTriggerMatchHLTJet50UAK5PF = cms.EDProducer("PATTriggerMatcherDRDPtLessByR",
    src = cms.InputTag("cleanPatJetsAK5PF"),
    maxDPtRel = cms.double(0.5),
    andOr = cms.bool(False),
    filterIdsEnum = cms.vstring('TriggerJet'),
...
process.jetTriggerMatchHLTJet50UAK5Track = cms.EDProducer("PATTriggerMatcherDRDPtLessByR",
    src = cms.InputTag("cleanPatJetsAK5Track"),
    maxDPtRel = cms.double(0.5),
    andOr = cms.bool(False),
    filterIdsEnum = cms.vstring('TriggerJet'),
...
process.jetTriggerMatchHLTJet50UIC5Calo = cms.EDProducer("PATTriggerMatcherDRDPtLessByR",
    src = cms.InputTag("cleanPatJetsIC5Calo"),
    maxDPtRel = cms.double(0.5),
    andOr = cms.bool(False),
    filterIdsEnum = cms.vstring('TriggerJet'),
...
process.jetTriggerMatchHLTJet50UPF = cms.EDProducer("PATTriggerMatcherDRDPtLessByR",
    src = cms.InputTag("selectedPatJetsPF"),
    maxDPtRel = cms.double(0.5),
    andOr = cms.bool(False),
    filterIdsEnum = cms.vstring('TriggerJet'),
...
process.metJESCorIC5CaloJetMuons = cms.EDProducer("MuonMET",
    muonMETDepositValueMapInputTag = cms.InputTag("muonMETValueMapProducer","muCorrData"),
    metTypeInputTag = cms.InputTag("CaloMET"),
    muonsInputTag = cms.InputTag("muons"),
...
process.muonTriggerMatchHLTDoubleMu3 = cms.EDProducer("PATTriggerMatcherDRDPtLessByR",
    src = cms.InputTag("cleanPatMuons"),
    maxDPtRel = cms.double(0.5),
    andOr = cms.bool(False),
    filterIdsEnum = cms.vstring('*'),
...
process.muonTriggerMatchHLTIsoMu3 = cms.EDProducer("PATTriggerMatcherDRDPtLessByR",
    src = cms.InputTag("cleanPatMuons"),
    maxDPtRel = cms.double(0.5),
    andOr = cms.bool(False),
    filterIdsEnum = cms.vstring('*'),
...
process.muonTriggerMatchHLTMu3 = cms.EDProducer("PATTriggerMatcherDRDPtLessByR",
    src = cms.InputTag("cleanPatMuons"),
    maxDPtRel = cms.double(0.5),
    andOr = cms.bool(False),
    filterIdsEnum = cms.vstring('*'),
...
process.muonTriggerMatchHLTMu9 = cms.EDProducer("PATTriggerMatcherDRDPtLessByR",
    src = cms.InputTag("cleanPatMuons"),
    maxDPtRel = cms.double(0.5),
    andOr = cms.bool(False),
    filterIdsEnum = cms.vstring('*'),
...
process.muonTriggerMatchHLTMu9PF = cms.EDProducer("PATTriggerMatcherDRDPtLessByR",
    src = cms.InputTag("selectedPatMuonsPF"),
    maxDPtRel = cms.double(0.5),
    andOr = cms.bool(False),
    filterIdsEnum = cms.vstring('*'),
...
process.muonTriggerMatchL1Muon = cms.EDProducer("PATTriggerMatcherDRDPtLessByR",
    src = cms.InputTag("cleanPatMuons"),
    maxDPtRel = cms.double(0.5),
    andOr = cms.bool(False),
...
process.patJetChargeIC5Calo = cms.EDProducer("JetChargeProducer",
    var = cms.string('Pt'),
    src = cms.InputTag("jetTracksAssociatorAtVertexIC5Calo"),
    exp = cms.double(1.0)
)
...
process.patJetCorrFactorsIC5Calo = cms.EDProducer("JetCorrFactorsProducer",
...
process.patJetFlavourAssociationIC5Calo = cms.EDProducer("JetFlavourIdentifier",
    srcByReference = cms.InputTag("patJetPartonAssociationIC5Calo"),
    physicsDefinition = cms.bool(False)
)
...
process.patJetGenJetMatchIC5Calo = cms.EDProducer("GenJetMatcher",
    src = cms.InputTag("iterativeCone5CaloJets"),
    maxDPtRel = cms.double(999999.0),
    mcPdgId = cms.vint32(),
    mcStatus = cms.vint32(),
...
process.patJetPartonAssociationIC5Calo = cms.EDProducer("JetPartonMatcher",
    jets = cms.InputTag("iterativeCone5CaloJets"),
    coneSizeToAssociate = cms.double(0.3),
    partons = cms.InputTag("patJetPartons")
)
...
process.patJetPartonMatchIC5Calo = cms.EDProducer("MCMatcher",
    src = cms.InputTag("iterativeCone5CaloJets"),
    maxDPtRel = cms.double(999999.0),
    mcPdgId = cms.vint32(1, 2, 3, 4, 5, 
        21),
...
process.patJetsAK5Track = cms.EDProducer("PATJetProducer",
    ...
    addEfficiencies = cms.bool(False),
    discriminatorSources = cms.VInputTag(cms.InputTag("jetBProbabilityBJetTagsAK5Track"), cms.InputTag("jetProbabilityBJetTagsAK5Track"), cms.InputTag("trackCountingHighPurBJetTagsAK5Track"), cms.InputTag("trackCountingHighEffBJetTagsAK5Track"), cms.InputTag("simpleSecondaryVertexHighEffBJetTagsAK5Track"), 
        cms.InputTag("simpleSecondaryVertexHighPurBJetTagsAK5Track"), cms.InputTag("combinedSecondaryVertexBJetTagsAK5Track"), cms.InputTag("combinedSecondaryVertexMVABJetTagsAK5Track"), cms.InputTag("softMuonBJetTagsAK5Track"), cms.InputTag("softMuonByPtBJetTagsAK5Track"), 
        cms.InputTag("softMuonByIP3dBJetTagsAK5Track")),
...
process.patJetsIC5Calo = cms.EDProducer("PATJetProducer",
    addJetCharge = cms.bool(True),
    addGenJetMatch = cms.bool(False),
    embedGenJetMatch = cms.bool(False),
    addAssociatedTracks = cms.bool(True),
    ...
    partonJetSource = cms.InputTag("NOT_IMPLEMENTED"),
    addGenPartonMatch = cms.bool(False),
    JetPartonMapSource = cms.InputTag("IC5Calo"),
    resolutions = cms.PSet(

    ),
    genPartonMatch = cms.InputTag("IC5Calo"),
    addTagInfos = cms.bool(False),
    addPartonJetMatch = cms.bool(False),
    embedGenPartonMatch = cms.bool(False),
    efficiencies = cms.PSet(
    ...
    genJetMatch = cms.InputTag("IC5Calo"),
    userData = cms.PSet(
        userCands = cms.PSet(
            src = cms.VInputTag("")
        ),
    ...
    jetSource = cms.InputTag("iterativeCone5CaloJets"),
    addEfficiencies = cms.bool(False),
    discriminatorSources = cms.VInputTag(cms.InputTag("jetBProbabilityBJetTagsIC5Calo"), cms.InputTag("jetProbabilityBJetTagsIC5Calo"), cms.InputTag("trackCountingHighPurBJetTagsIC5Calo"), cms.InputTag("trackCountingHighEffBJetTagsIC5Calo"), cms.InputTag("simpleSecondaryVertexHighEffBJetTagsIC5Calo"), 
        cms.InputTag("simpleSecondaryVertexHighPurBJetTagsIC5Calo"), cms.InputTag("combinedSecondaryVertexBJetTagsIC5Calo"), cms.InputTag("combinedSecondaryVertexMVABJetTagsIC5Calo"), cms.InputTag("softMuonBJetTagsIC5Calo"), cms.InputTag("softMuonByPtBJetTagsIC5Calo"), 
        cms.InputTag("softMuonByIP3dBJetTagsIC5Calo")),
    trackAssociationSource = cms.InputTag("jetTracksAssociatorAtVertexIC5Calo"),
    tagInfoSources = cms.VInputTag(cms.InputTag("impactParameterTagInfosIC5Calo"), cms.InputTag("secondaryVertexTagInfosIC5Calo"), cms.InputTag("softMuonTagInfosIC5Calo")),
    jetCorrFactorsSource = cms.VInputTag(cms.InputTag("patJetCorrFactorsIC5Calo")),
    embedPFCandidates = cms.bool(True),
    addJetCorrFactors = cms.bool(True),
    addResolutions = cms.bool(False),
    getJetMCFlavour = cms.bool(False),
    addDiscriminators = cms.bool(True),
    jetChargeSource = cms.InputTag("patJetChargeIC5Calo"),
    embedCaloTowers = cms.bool(True),
    jetIDMap = cms.InputTag("ic5JetID"),
    addJetID = cms.bool(True)
)
...
process.patMETsIC5Calo = cms.EDProducer("PATMETProducer",
...
process.patTrigger = cms.EDProducer("PATTriggerProducer",
    processName = cms.string(options.hltres),
...
process.patTriggerEvent = cms.EDProducer("PATTriggerEventProducer",
    patTriggerMatches = cms.VInputTag("electronTriggerMatchHLTEle15LWL1R", "muonTriggerMatchHLTMu9", "tauTriggerMatchHLTJet15U", "tauTriggerMatchHLTJet30U", "tauTriggerMatchHLTJet50U", 
        "jetTriggerMatchHLTJet15UAK5Calo", "jetTriggerMatchHLTJet30UAK5Calo", "jetTriggerMatchHLTJet50UAK5Calo"),
    processName = cms.string(options.hltres)
    #processName = cms.string('HLT')
)
...
process.photonTriggerMatchHLTPhoton30 = cms.EDProducer("PATTriggerMatcherDRDPtLessByR",
    src = cms.InputTag("cleanPatPhotons"),
    maxDPtRel = cms.double(0.5),
    andOr = cms.bool(False),
    ...
    filterLabels = cms.vstring('*'),
    collectionTags = cms.vstring('*'),
    pathNames = cms.vstring('HLT_Photon30'),
    resolveByMatchQuality = cms.bool(False),
    maxDeltaR = cms.double(0.5),
    filterIds = cms.vint32(0),
    resolveAmbiguities = cms.bool(True),
...
process.secondaryVertexTagInfosIC5Calo = cms.EDProducer("SecondaryVertexProducer",
    beamSpotTag = cms.InputTag("offlineBeamSpot"),
    vertexReco = cms.PSet(
        seccut = cms.double(6.0),
        primcut = cms.double(1.8),
    ...
    trackIPTagInfos = cms.InputTag("impactParameterTagInfosIC5Calo"),
    minimumTrackWeight = cms.double(0.5),
    usePVError = cms.bool(True),
    trackSelection = cms.PSet(
        totalHitsMin = cms.uint32(8),
...
process.simpleSecondaryVertexHighEffBJetTagsAK5Track = cms.EDProducer("JetTagProducer",
    jetTagComputer = cms.string('simpleSecondaryVertex2Trk'),
...
process.simpleSecondaryVertexHighEffBJetTagsIC5Calo = cms.EDProducer("JetTagProducer",
    jetTagComputer = cms.string('simpleSecondaryVertex2Trk'),
    tagInfos = cms.VInputTag(cms.InputTag("secondaryVertexTagInfosIC5Calo"))
)
...
process.simpleSecondaryVertexHighPurBJetTagsAK5Track = cms.EDProducer("JetTagProducer",
    jetTagComputer = cms.string('simpleSecondaryVertex3Trk'),
    tagInfos = cms.VInputTag(cms.InputTag("secondaryVertexTagInfosAK5Track"))
)
...
process.simpleSecondaryVertexHighPurBJetTagsIC5Calo = cms.EDProducer("JetTagProducer",
    jetTagComputer = cms.string('simpleSecondaryVertex3Trk'),
    tagInfos = cms.VInputTag(cms.InputTag("secondaryVertexTagInfosIC5Calo"))
)
...
process.softMuonBJetTagsIC5Calo = cms.EDProducer("JetTagProducer",
    jetTagComputer = cms.string('softMuon'),
    tagInfos = cms.VInputTag(cms.InputTag("softMuonTagInfosIC5Calo"))
)
...
process.softMuonByIP3dBJetTagsIC5Calo = cms.EDProducer("JetTagProducer",
    jetTagComputer = cms.string('softLeptonByIP3d'),
    tagInfos = cms.VInputTag(cms.InputTag("softMuonTagInfosIC5Calo"))
)
...
process.softMuonByPtBJetTagsIC5Calo = cms.EDProducer("JetTagProducer",
    jetTagComputer = cms.string('softLeptonByPt'),
    tagInfos = cms.VInputTag(cms.InputTag("softMuonTagInfosIC5Calo"))
)
...
process.softMuonTagInfosIC5Calo = cms.EDProducer("SoftLepton",
    muonSelection = cms.uint32(1),
    leptons = cms.InputTag("muons"),
    primaryVertex = cms.InputTag("offlinePrimaryVertices"),
    leptonCands = cms.InputTag(""),
...
process.tauTriggerMatchHLTDoubleLooseIsoTau15 = cms.EDProducer("PATTriggerMatcherDRDPtLessByR",
    src = cms.InputTag("cleanPatTaus"),
    maxDPtRel = cms.double(0.5),
    andOr = cms.bool(False),
    filterIdsEnum = cms.vstring('*'),
...
process.tauTriggerMatchHLTJet15U = cms.EDProducer("PATTriggerMatcherDRDPtLessByR",
    src = cms.InputTag("cleanPatTaus"),
    maxDPtRel = cms.double(0.5),
    andOr = cms.bool(False),
    filterIdsEnum = cms.vstring('TriggerTau'),
    filterLabels = cms.vstring('*'),
    collectionTags = cms.vstring('*'),
    pathNames = cms.vstring('HLT_Jet15U'),
    resolveByMatchQuality = cms.bool(False),
...
process.tauTriggerMatchHLTJet15UPF = cms.EDProducer("PATTriggerMatcherDRDPtLessByR",
    src = cms.InputTag("selectedPatTausPF"),
    maxDPtRel = cms.double(0.5),
    andOr = cms.bool(False),
    filterIdsEnum = cms.vstring('TriggerTau'),
...
process.tauTriggerMatchHLTJet30U = cms.EDProducer("PATTriggerMatcherDRDPtLessByR",
    src = cms.InputTag("cleanPatTaus"),
    maxDPtRel = cms.double(0.5),
    andOr = cms.bool(False),
    filterIdsEnum = cms.vstring('TriggerTau'),
...
process.tauTriggerMatchHLTJet30UPF = cms.EDProducer("PATTriggerMatcherDRDPtLessByR",
    src = cms.InputTag("selectedPatTausPF"),
    maxDPtRel = cms.double(0.5),
    andOr = cms.bool(False),
    filterIdsEnum = cms.vstring('TriggerTau'),
...
process.tauTriggerMatchHLTJet50U = cms.EDProducer("PATTriggerMatcherDRDPtLessByR",
    src = cms.InputTag("cleanPatTaus"),
    maxDPtRel = cms.double(0.5),
    andOr = cms.bool(False),
    filterIdsEnum = cms.vstring('TriggerTau'),
...
process.tauTriggerMatchHLTJet50UPF = cms.EDProducer("PATTriggerMatcherDRDPtLessByR",
    src = cms.InputTag("selectedPatTausPF"),
    maxDPtRel = cms.double(0.5),
    andOr = cms.bool(False),
    filterIdsEnum = cms.vstring('TriggerTau'),
...
process.trackCountingHighEffBJetTagsIC5Calo = cms.EDProducer("JetTagProducer",
    jetTagComputer = cms.string('trackCounting3D2nd'),
    tagInfos = cms.VInputTag(cms.InputTag("impactParameterTagInfosIC5Calo"))
)
...
process.trackCountingHighPurBJetTagsIC5Calo = cms.EDProducer("JetTagProducer",
    jetTagComputer = cms.string('trackCounting3D3rd'),
    tagInfos = cms.VInputTag(cms.InputTag("impactParameterTagInfosIC5Calo"))
)


process.triggerMatchedPatElectrons = cms.EDProducer("PATTriggerMatchElectronEmbedder",
    matches = cms.VInputTag("electronTriggerMatchHLTEle15LWL1R"),
    src = cms.InputTag("cleanPatElectrons")
)


process.triggerMatchedPatElectronsPF = cms.EDProducer("PATTriggerMatchElectronEmbedder",
    matches = cms.VInputTag("electronTriggerMatchHLTEle15LWL1RPF"),
    src = cms.InputTag("selectedPatElectronsPF")
)


process.triggerMatchedPatJetsAK5Calo = cms.EDProducer("PATTriggerMatchJetEmbedder",
    matches = cms.VInputTag("jetTriggerMatchHLTJet15UAK5Calo", "jetTriggerMatchHLTJet30UAK5Calo", "jetTriggerMatchHLTJet50UAK5Calo"),
    src = cms.InputTag("cleanPatJetsAK5Calo")
)


process.triggerMatchedPatJetsAK5JPT = cms.EDProducer("PATTriggerMatchJetEmbedder",
    matches = cms.VInputTag("jetTriggerMatchHLTJet15UAK5JPT", "jetTriggerMatchHLTJet30UAK5JPT", "jetTriggerMatchHLTJet50UAK5JPT"),
    src = cms.InputTag("cleanPatJetsAK5JPT")
)


process.triggerMatchedPatJetsAK5PF = cms.EDProducer("PATTriggerMatchJetEmbedder",
    matches = cms.VInputTag("jetTriggerMatchHLTJet15UAK5PF", "jetTriggerMatchHLTJet30UAK5PF", "jetTriggerMatchHLTJet50UAK5PF"),
    src = cms.InputTag("cleanPatJetsAK5PF")
)


process.triggerMatchedPatJetsAK5Track = cms.EDProducer("PATTriggerMatchJetEmbedder",
    matches = cms.VInputTag("jetTriggerMatchHLTJet15UAK5Track", "jetTriggerMatchHLTJet30UAK5Track", "jetTriggerMatchHLTJet50UAK5Track"),
    src = cms.InputTag("cleanPatJetsAK5Track")
)


process.triggerMatchedPatJetsIC5Calo = cms.EDProducer("PATTriggerMatchJetEmbedder",
    matches = cms.VInputTag("jetTriggerMatchHLTJet15UIC5Calo", "jetTriggerMatchHLTJet30UIC5Calo", "jetTriggerMatchHLTJet50UIC5Calo"),
    src = cms.InputTag("cleanPatJetsIC5Calo")
)


process.triggerMatchedPatJetsPF = cms.EDProducer("PATTriggerMatchJetEmbedder",
    matches = cms.VInputTag("jetTriggerMatchHLTJet15UPF", "jetTriggerMatchHLTJet30UPF", "jetTriggerMatchHLTJet50UPF"),
    src = cms.InputTag("selectedPatJetsPF")
)


process.triggerMatchedPatMuons = cms.EDProducer("PATTriggerMatchMuonEmbedder",
    matches = cms.VInputTag("muonTriggerMatchHLTMu9"),
    src = cms.InputTag("cleanPatMuons")
)


process.triggerMatchedPatMuonsPF = cms.EDProducer("PATTriggerMatchMuonEmbedder",
    matches = cms.VInputTag("muonTriggerMatchHLTMu9PF"),
    src = cms.InputTag("selectedPatMuonsPF")
)


process.triggerMatchedPatPhotons = cms.EDProducer("PATTriggerMatchPhotonEmbedder",
    matches = cms.VInputTag("photonTriggerMatchHLTPhoton30"),
    src = cms.InputTag("cleanPatPhotons")
)


process.triggerMatchedPatTaus = cms.EDProducer("PATTriggerMatchTauEmbedder",
    matches = cms.VInputTag("tauTriggerMatchHLTJet15U", "tauTriggerMatchHLTJet30U", "tauTriggerMatchHLTJet50U"),
    src = cms.InputTag("cleanPatTaus")
)


process.triggerMatchedPatTausPF = cms.EDProducer("PATTriggerMatchTauEmbedder",
    matches = cms.VInputTag("tauTriggerMatchHLTJet15UPF", "tauTriggerMatchHLTJet30UPF", "tauTriggerMatchHLTJet50UPF"),
    src = cms.InputTag("selectedPatTausPF")
)
...
process.countPatJetsIC5Calo = cms.EDFilter("PATCandViewCountFilter",
    maxNumber = cms.uint32(999999),
    src = cms.InputTag("cleanPatJetsIC5Calo"),
    minNumber = cms.uint32(0)
)
...
process.selectedPatJetsIC5Calo = cms.EDFilter("PATJetSelector",
...
process.analysisNtuplePAT = cms.EDAnalyzer("AnalysisNtuplePAT",
    ...
    triggerParameters = cms.untracked.PSet(
        hlTriggerResults = cms.untracked.InputTag("TriggerResults","",options.hltres),
...
process.cleanPatCandidateSummary = cms.EDAnalyzer("CandidateSummaryTable",
    ...
    candidates = cms.VInputTag(cms.InputTag("cleanPatElectrons"), cms.InputTag("cleanPatMuons"), cms.InputTag("cleanPatTaus"), cms.InputTag("cleanPatPhotons"), cms.InputTag("cleanPatJetsAK5Calo"), 
        cms.InputTag("cleanPatJetsIC5Calo"), cms.InputTag("cleanPatJetsAK5JPT"), cms.InputTag("cleanPatJetsAK5PF"), cms.InputTag("cleanPatJetsAK5Track"))
)


process.cleanPatCandidateSummaryPF = cms.EDAnalyzer("CandidateSummaryTable",
    candidates = cms.VInputTag(cms.InputTag("cleanPatElectronsPF"), cms.InputTag("cleanPatMuonsPF"), cms.InputTag("cleanPatPhotonsPF"), cms.InputTag("cleanPatTausPF"), cms.InputTag("cleanPatJetsPF")),
    logName = cms.untracked.string('cleanPatCandidates|PATSummaryTables')
)
...
process.patCandidateSummary = cms.EDAnalyzer("CandidateSummaryTable",
    ...
    candidates = cms.VInputTag(cms.InputTag("patElectrons"), cms.InputTag("patMuons"), cms.InputTag("patTaus"), cms.InputTag("patPhotons"), cms.InputTag("patJets"), 
        cms.InputTag("patMETsIC5Calo"), cms.InputTag("patMETsTC"), cms.InputTag("patMETsAK5Calo"), cms.InputTag("patMHTsAK5Calo"), cms.InputTag("patJetsIC5Calo"), 
        cms.InputTag("patJetsAK5JPT"), cms.InputTag("patJetsAK5PF"), cms.InputTag("patJetsAK5Track"))
)


process.patCandidateSummaryPF = cms.EDAnalyzer("CandidateSummaryTable",
    candidates = cms.VInputTag(cms.InputTag("patElectronsPF"), cms.InputTag("patMuonsPF"), cms.InputTag("patPhotonsPF"), cms.InputTag("patTausPF"), cms.InputTag("patJetsPF"), cms.InputTag("patMETsPF"), 
...
process.selectedPatCandidateSummary = cms.EDAnalyzer("CandidateSummaryTable",
    ...
    candidates = cms.VInputTag(cms.InputTag("selectedPatElectrons"), cms.InputTag("selectedPatMuons"), cms.InputTag("selectedPatTaus"), cms.InputTag("selectedPatPhotons"), cms.InputTag("selectedPatJets"), 
        cms.InputTag("selectedPatJetsIC5Calo"), cms.InputTag("selectedPatJetsAK5JPT"), cms.InputTag("selectedPatJetsAK5PF"), cms.InputTag("selectedPatJetsAK5Track"))
)


process.selectedPatCandidateSummaryPF = cms.EDAnalyzer("CandidateSummaryTable",
    candidates = cms.VInputTag(cms.InputTag("selectedPatElectronsPF"), cms.InputTag("selectedPatMuonsPF"), cms.InputTag("selectedPatPhotonsPF"), cms.InputTag("selectedPatTausPF"), cms.InputTag("selectedPatJetsPF"), cms.InputTag("selectedPatPFParticles")),
    logName = cms.untracked.string('selectedPatCanddiates|PATSummaryTables')
)
...
process.selectedPatCandidatesPF = cms.Sequence(process.selectedPatElectronsPF+process.selectedPatMuonsPF+process.selectedPatPhotonsPF+process.selectedPatTausPF+process.selectedPatJetsPF+process.selectedPatPFParticles+process.selectedPatCandidateSummaryPF)
...
process.tautagging = cms.Sequence(process.jptRecoTauProducer*process.caloRecoTauProducer*process.caloRecoTauDiscriminationByLeadingTrackFinding*process.caloRecoTauDiscriminationByLeadingTrackPtCut*process.caloRecoTauDiscriminationByIsolation*process.caloRecoTauDiscriminationAgainstElectron)
...
process.patTriggerMatcherPF = cms.Sequence(process.electronTriggerMatchHLTEle15LWL1RPF+process.muonTriggerMatchHLTMu9PF+process.jetTriggerMatchHLTJet15UPF+process.jetTriggerMatchHLTJet30UPF+process.jetTriggerMatchHLTJet50UPF+process.tauTriggerMatchHLTJet15UPF+process.tauTriggerMatchHLTJet30UPF+process.tauTriggerMatchHLTJet50UPF)
...
process.patMETCorrections = cms.Sequence((process.metJESCorAK5CaloJetTypeII*process.metJESCorAK5CaloJetMuonsTypeII+process.metJESCorAK5CaloJet)*process.metJESCorIC5CaloJet*process.metJESCorAK5CaloJetMuons*process.metJESCorIC5CaloJetMuons)
...
process.countPatCandidatesPF = cms.Sequence(process.countPatElectronsPF+process.countPatMuonsPF+process.countPatPhotonsPF+process.countPatTausPF+process.countPatLeptonsPF+process.countPatJetsPF+process.countPatPFParticles)
...
process.makePatMETs = cms.Sequence(process.patMETCorrections*(process.patMETsAK5Calo+process.patMETsAK5CaloTypeII)*process.patMETsTC*process.patMETsIC5Calo)


process.patTriggerMatcher = cms.Sequence(process.electronTriggerMatchHLTEle15LWL1R+process.muonTriggerMatchHLTMu9+process.photonTriggerMatchHLTPhoton30+process.jetTriggerMatchHLTJet15UAK5Calo+process.jetTriggerMatchHLTJet15UIC5Calo+process.jetTriggerMatchHLTJet15UAK5JPT+process.jetTriggerMatchHLTJet15UAK5PF+process.jetTriggerMatchHLTJet15UAK5Track+process.jetTriggerMatchHLTJet30UAK5Calo+process.jetTriggerMatchHLTJet30UIC5Calo+process.jetTriggerMatchHLTJet30UAK5JPT+process.jetTriggerMatchHLTJet30UAK5PF+process.jetTriggerMatchHLTJet30UAK5Track+process.jetTriggerMatchHLTJet50UAK5Calo+process.jetTriggerMatchHLTJet50UIC5Calo+process.jetTriggerMatchHLTJet50UAK5JPT+process.jetTriggerMatchHLTJet50UAK5PF+process.jetTriggerMatchHLTJet50UAK5Track+process.tauTriggerMatchHLTJet15U+process.tauTriggerMatchHLTJet30U+process.tauTriggerMatchHLTJet50U)
...
process.selectedPatCandidates = cms.Sequence(process.selectedPatElectrons+process.selectedPatMuons+process.selectedPatTaus+process.selectedPatPhotons+process.selectedPatJets*process.selectedPatJetsAK5Track*process.selectedPatJetsAK5PF*process.selectedPatJetsAK5JPT*process.selectedPatJetsIC5Calo+process.selectedPatCandidateSummary)


process.countPatCandidates = cms.Sequence(process.countPatElectrons+process.countPatMuons+process.countPatTaus+process.countPatLeptons+process.countPatPhotons+process.countPatJets*process.countPatJetsAK5Track*process.countPatJetsAK5PF*process.countPatJetsAK5JPT*process.countPatJetsIC5Calo)
...
process.makePatMETsPF = cms.Sequence(process.patMETsPF)


process.btaggingJetTagsIC5Calo = cms.Sequence(process.jetBProbabilityBJetTagsIC5Calo+process.jetProbabilityBJetTagsIC5Calo+process.trackCountingHighPurBJetTagsIC5Calo+process.trackCountingHighEffBJetTagsIC5Calo+process.simpleSecondaryVertexHighEffBJetTagsIC5Calo+process.simpleSecondaryVertexHighPurBJetTagsIC5Calo+process.combinedSecondaryVertexBJetTagsIC5Calo+process.combinedSecondaryVertexMVABJetTagsIC5Calo+process.softMuonBJetTagsIC5Calo+process.softMuonByPtBJetTagsIC5Calo+process.softMuonByIP3dBJetTagsIC5Calo)
...
process.patJetCorrections = cms.Sequence(process.patJetCorrFactors*process.patJetCorrFactorsAK5PF*process.patJetCorrFactorsAK5JPT*process.patJetCorrFactorsIC5Calo)
...
process.btaggingJetTagsAK5Track = cms.Sequence(process.jetBProbabilityBJetTagsAK5Track+process.jetProbabilityBJetTagsAK5Track+process.trackCountingHighPurBJetTagsAK5Track+process.trackCountingHighEffBJetTagsAK5Track+process.simpleSecondaryVertexHighEffBJetTagsAK5Track+process.simpleSecondaryVertexHighPurBJetTagsAK5Track+process.combinedSecondaryVertexBJetTagsAK5Track+process.combinedSecondaryVertexMVABJetTagsAK5Track+process.softMuonBJetTagsAK5Track+process.softMuonByPtBJetTagsAK5Track+process.softMuonByIP3dBJetTagsAK5Track)
...
process.patTriggerSequence = cms.Sequence(process.patTrigger*process.patTriggerMatcher*process.patTriggerEvent+process.triggerMatchedPatElectrons+process.triggerMatchedPatMuons+process.triggerMatchedPatPhotons+process.triggerMatchedPatJetsAK5Calo+process.triggerMatchedPatJetsIC5Calo+process.triggerMatchedPatJetsAK5JPT+process.triggerMatchedPatJetsAK5PF+process.triggerMatchedPatJetsAK5Track+process.triggerMatchedPatTaus)
...
process.btaggingTagInfosIC5Calo = cms.Sequence(process.impactParameterTagInfosIC5Calo+process.secondaryVertexTagInfosIC5Calo+process.softMuonTagInfosIC5Calo+process.btaggingJetTagsIC5Calo)
...
process.patTriggerSequencePF = cms.Sequence(process.patTrigger*process.patTriggerMatcherPF*process.patTriggerEvent+process.triggerMatchedPatElectronsPF+process.triggerMatchedPatMuonsPF+process.triggerMatchedPatJetsPF+process.triggerMatchedPatTausPF)
...
process.btaggingIC5Calo = cms.Sequence(process.btaggingTagInfosIC5Calo)
...
process.makePatJets = cms.Sequence(process.patJetCorrections*(process.jetTracksAssociatorAtVertexIC5Calo+process.btaggingIC5Calo+(process.jetTracksAssociatorAtVertexAK5JPT+process.btaggingAK5JPT+(process.jetTracksAssociatorAtVertexAK5PF+process.btaggingAK5PF+(process.jetTracksAssociatorAtVertexAK5Track+process.btaggingAK5Track+process.patJetCharge*process.patJetChargeAK5Track)*process.patJetChargeAK5PF)*process.patJetChargeAK5JPT)*process.patJetChargeIC5Calo)*process.patJets*process.patJetsAK5Track*process.patJetsAK5PF*process.patJetsAK5JPT*process.patJetsIC5Calo)
...
process.patCandidatesPF = cms.Sequence(process.makePatElectronsPF+process.makePatMuonsPF+process.makePatPhotonsPF+process.makePatTausPF+process.makePatJetsPF+process.makePatMETsPF+process.patPFParticles+process.patCandidateSummaryPF)


process.patDefaultSequencePF = cms.Sequence(process.patCandidatesPF+process.selectedPatCandidatesPF+process.cleanPatCandidatesPF+process.countPatCandidatesPF+process.patTriggerSequencePF)
...
process.ak5TRKL1L2L3 = cms.ESSource("JetCorrectionServiceChain",
    correctors = cms.vstring('L1Fastjet', 
        'ak5TRKL2Relative', 
        'ak5TRKL3Absolute')
)
...
process.ak5TRKL2L3 = cms.ESSource("JetCorrectionServiceChain",
    correctors = cms.vstring('ak5TRKL2Relative', 
        'ak5TRKL3Absolute')
)


process.ak5TRKL2Relative = cms.ESSource("LXXXCorrectionService",
    useCondDB = cms.untracked.bool(True),
    era = cms.string(''),
    section = cms.string(''),
...
process.ak5TRKL3Absolute = cms.ESSource("LXXXCorrectionService",
    useCondDB = cms.untracked.bool(True),
    era = cms.string(''),
    section = cms.string(''),
    algorithm = cms.string('AK5TRK'),
...
#file = open('SusyPAT_DATA_'+options.cfgfilename+'.py','w')
