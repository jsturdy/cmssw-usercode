...
process.source = cms.Source("PoolSource",
    fileNames = cms.untracked.vstring(
        '/store/data/Run2010A/JetMETTau/RECO/v4/000/139/347/B40EB15F-2D87-DF11-9D43-003048CFB40C.root',
        '/store/data/Run2010A/JetMETTau/RECO/v4/000/139/347/8A4EAAF2-2B87-DF11-B2BF-003048F117B6.root',
        '/store/data/Run2010A/JetMETTau/RECO/v4/000/139/347/80F7D1F4-2B87-DF11-9BA4-003048F117EA.root',
        '/store/data/Run2010A/JetMETTau/RECO/v4/000/139/347/7A821E60-3087-DF11-80C3-0030487CD6D8.root',
        '/store/data/Run2010A/JetMETTau/RECO/v4/000/139/347/3421CA60-3087-DF11-949B-0030487CAF5E.root'
    ),
...
process.out = cms.OutputModule("PoolOutputModule",
    fileName = cms.untracked.string('SUSYPAT_V9_DATA_prompt.root'),
...
process.TFileService = cms.Service("TFileService",
    fileName = cms.string('PATtuple_DATA_prompt.root')
)
...
process.GlobalTag = cms.ESSource("PoolDBESSource",
    ...
    globaltag = cms.string('GR10_P_V7::All')
)
