...
process.source = cms.Source("PoolSource",
    fileNames = cms.untracked.vstring('file:/tmp/sturdy/SUSY-LM9.root'),
...
process.out = cms.OutputModule("PoolOutputModule",
    fileName = cms.untracked.string('SUSYPAT_V9_MC_35X.root'),
...
process.susyPatDefaultSequence = cms.Sequence(process.eventCountProducer*process.recoJPTJets*process.patDefaultSequence*process.patPF2PATSequencePF)
...
process.TFileService = cms.Service("TFileService",
    fileName = cms.string('PATtuple_MC_35X.root')
)
...
process.GlobalTag = cms.ESSource("PoolDBESSource",
    ...
    globaltag = cms.string('START3X_V26::All')
)
