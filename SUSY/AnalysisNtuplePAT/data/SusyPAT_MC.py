...
process.source = cms.Source("PoolSource",
    fileNames = cms.untracked.vstring('file:/tmp/sturdy/TTbar-mcatnlo.root'),
...
process.hbheNoiseFlag = cms.EDProducer("HBHENoiseFilterResultProducer",
    minRBXHits = cms.int32(999),
    minHighEHitTime = cms.double(-9999.0),
    minHPDNoOtherHits = cms.int32(10),
    maxRatio = cms.double(0.96),
...
process.metJESType2CorAK5CaloJet = cms.EDProducer("Type1MET",
    inputUncorJetsLabel = cms.string('iterativeCone5CaloJets'),
    jetEMfracLimit = cms.double(0.9),
    metType = cms.string('CaloMET'),
    jetPTthreshold = cms.double(20.0),
...
process.metJESType2CorAK7CaloJet = cms.EDProducer("Type1MET",
    inputUncorJetsLabel = cms.string('iterativeCone5CaloJets'),
    jetEMfracLimit = cms.double(0.9),
    metType = cms.string('CaloMET'),
    jetPTthreshold = cms.double(20.0),
...
process.metJESType2CorIC5CaloJet = cms.EDProducer("Type1MET",
    inputUncorJetsLabel = cms.string('iterativeCone5CaloJets'),
    jetEMfracLimit = cms.double(0.9),
    metType = cms.string('CaloMET'),
    jetPTthreshold = cms.double(20.0),
...
process.metJESType2CorKT4CaloJet = cms.EDProducer("Type1MET",
    inputUncorJetsLabel = cms.string('iterativeCone5CaloJets'),
    jetEMfracLimit = cms.double(0.9),
    metType = cms.string('CaloMET'),
    jetPTthreshold = cms.double(20.0),
...
process.metJESType2CorKT6CaloJet = cms.EDProducer("Type1MET",
    inputUncorJetsLabel = cms.string('iterativeCone5CaloJets'),
    jetEMfracLimit = cms.double(0.9),
    metType = cms.string('CaloMET'),
    jetPTthreshold = cms.double(20.0),
...
process.metJESType2CorSC5CaloJet = cms.EDProducer("Type1MET",
    inputUncorJetsLabel = cms.string('iterativeCone5CaloJets'),
    jetEMfracLimit = cms.double(0.9),
    metType = cms.string('CaloMET'),
    jetPTthreshold = cms.double(20.0),
...
process.metJESType2CorSC7CaloJet = cms.EDProducer("Type1MET",
    inputUncorJetsLabel = cms.string('sisCone7CaloJets'),
    jetEMfracLimit = cms.double(0.9),
    metType = cms.string('CaloMET'),
    jetPTthreshold = cms.double(20.0),
...
process.patTriggerEvent = cms.EDProducer("PATTriggerEventProducer",
    patTriggerMatches = cms.VInputTag("electronTriggerMatchHLTEle15LWL1R", "electronTriggerMatchHLTDoubleEle5SWL1R", "muonTriggerMatchL1Muon", "muonTriggerMatchHLTIsoMu3", "muonTriggerMatchHLTMu3", 
        "muonTriggerMatchHLTDoubleMu3", "tauTriggerMatchHLTDoubleLooseIsoTau15"),
    processName = cms.string('HLT')
)
...
process.countPatLeptonsPF = cms.EDFilter("PATLeptonCountFilter",
    maxNumber = cms.uint32(999999),
    countElectrons = cms.bool(True),
    muonSource = cms.InputTag("cleanPatMuonsPF"),
    minNumber = cms.uint32(0),
    electronSource = cms.InputTag("cleanPatElectronsPF"),
    tauSource = cms.InputTag("cleanPatTausPF"),
    countTaus = cms.bool(False),
    countMuons = cms.bool(True)
)
...
process.pfElectronsPtGt5 = cms.EDFilter("PtMinPFCandidateSelector",
    src = cms.InputTag("pfAllElectrons"),
    ptMin = cms.double(5.0)
)


process.pfElectronsPtGt5PF = cms.EDFilter("PtMinPFCandidateSelector",
...
process.pfMuonsPtGt5 = cms.EDFilter("PtMinPFCandidateSelector",
    src = cms.InputTag("pfAllMuons"),
    ptMin = cms.double(5.0)
)


process.pfMuonsPtGt5PF = cms.EDFilter("PtMinPFCandidateSelector",
...
process.analysisNtuplePAT = cms.EDAnalyzer("AnalysisNtuplePAT",
    ...
    pfJetParameters = cms.untracked.PSet(
        ...
        useJPTJets = cms.untracked.bool(False),
        jetMaxEMF = cms.untracked.double(0.99),
        jetTag = cms.untracked.InputTag("cleanPatJetsPF"),
        genJetTag = cms.untracked.InputTag("ak5GenJets"),
        doMCJets = cms.untracked.bool(True),
        jetMinEMF = cms.untracked.double(0.01),
...
process.cleanPatCandidateSummary = cms.EDAnalyzer("CandidateSummaryTable",
    ...
    candidates = cms.VInputTag(cms.InputTag("cleanPatElectrons"), cms.InputTag("cleanPatMuons"), cms.InputTag("cleanPatTaus"), cms.InputTag("cleanPatPhotons"), cms.InputTag("cleanPatJetsAK5Calo"), 
        cms.InputTag("cleanPatJetsAK5Track"), cms.InputTag("cleanPatJetsAK5JPT"), cms.InputTag("cleanPatJetsAK5PF"))
)
...
process.patCandidateSummary = cms.EDAnalyzer("CandidateSummaryTable",
    ...
    candidates = cms.VInputTag(cms.InputTag("patElectrons"), cms.InputTag("patMuons"), cms.InputTag("patTaus"), cms.InputTag("patPhotons"), cms.InputTag("patJets"), 
        cms.InputTag("patMETsTC"), cms.InputTag("patMETsAK5Calo"), cms.InputTag("patMHTsAK5Calo"), cms.InputTag("patJetsAK5Track"), cms.InputTag("patJetsAK5JPT"), 
        cms.InputTag("patJetsAK5PF"))
)


process.patCandidateSummaryPF = cms.EDAnalyzer("CandidateSummaryTable",
    candidates = cms.VInputTag(cms.InputTag("patElectronsPF"), cms.InputTag("patMuonsPF"), cms.InputTag("patTausPF"), cms.InputTag("patPhotonsPF"), cms.InputTag("patJetsPF"), cms.InputTag("patMETsPF"), 
...
process.selectedPatCandidateSummary = cms.EDAnalyzer("CandidateSummaryTable",
    ...
    candidates = cms.VInputTag(cms.InputTag("selectedPatElectrons"), cms.InputTag("selectedPatMuons"), cms.InputTag("selectedPatTaus"), cms.InputTag("selectedPatPhotons"), cms.InputTag("selectedPatJets"), 
        cms.InputTag("selectedPatJetsAK5Track"), cms.InputTag("selectedPatJetsAK5JPT"), cms.InputTag("selectedPatJetsAK5PF"))
)


process.selectedPatCandidateSummaryPF = cms.EDAnalyzer("CandidateSummaryTable",
    candidates = cms.VInputTag(cms.InputTag("selectedPatElectronsPF"), cms.InputTag("selectedPatMuonsPF"), cms.InputTag("selectedPatTausPF"), cms.InputTag("selectedPatPhotonsPF"), cms.InputTag("selectedPatJetsPF"), cms.InputTag("selectedPatPFParticles")),
    logName = cms.untracked.string('selectedPatCanddiates|PATSummaryTables')
)


process.out = cms.OutputModule("PoolOutputModule",
    fileName = cms.untracked.string('SUSYPAT_V9_MC.root'),
    ...
    selecteEvents = cms.untracked.PSet(
...
process.selectedPatCandidatesPF = cms.Sequence(process.selectedPatElectronsPF+process.selectedPatMuonsPF+process.selectedPatTausPF+process.selectedPatPhotonsPF+process.selectedPatJetsPF+process.selectedPatPFParticles+process.selectedPatCandidateSummaryPF)
...
process.patJetFlavourId = cms.Sequence(process.patJetPartons*process.patJetPartonAssociation*process.patJetPartonAssociationAK5PF*process.patJetPartonAssociationAK5JPT*process.patJetPartonAssociationAK5Track*process.patJetFlavourAssociation*process.patJetFlavourAssociationAK5PF*process.patJetFlavourAssociationAK5JPT*process.patJetFlavourAssociationAK5Track)
...
process.countPatCandidatesPF = cms.Sequence(process.countPatElectronsPF+process.countPatMuonsPF+process.countPatTausPF+process.countPatLeptonsPF+process.countPatPhotonsPF+process.countPatJetsPF+process.countPatPFParticles)
...
process.makePatMETs = cms.Sequence(process.patMETCorrections*process.patMETsAK5Calo*process.patMETsTC)
...
process.cleanPatCandidates = cms.Sequence(process.cleanPatMuons*process.cleanPatElectrons*process.cleanPatPhotons*process.cleanPatTaus*process.cleanPatJetsAK5Calo*process.cleanPatJetsAK5PF*process.cleanPatJetsAK5JPT*process.cleanPatJetsAK5Track*process.cleanPatCandidateSummary)
...
process.MetType2Corrections = cms.Sequence(process.metJESType2CorIC5CaloJet*process.metJESType2CorKT4CaloJet*process.metJESType2CorKT6CaloJet*process.metJESType2CorAK5CaloJet*process.metJESType2CorAK7CaloJet*process.metJESType2CorSC5CaloJet*process.metJESType2CorSC7CaloJet)
...
process.cleanupFilterMC = cms.Sequence(process.removePKAM+process.primaryVertexFilter+process.hbheNoiseFlag)
...
process.selectedPatCandidates = cms.Sequence(process.selectedPatElectrons+process.selectedPatMuons+process.selectedPatTaus+process.selectedPatPhotons+process.selectedPatJets*process.selectedPatJetsAK5PF*process.selectedPatJetsAK5JPT*process.selectedPatJetsAK5Track+process.selectedPatCandidateSummary)


process.countPatCandidates = cms.Sequence(process.countPatElectrons+process.countPatMuons+process.countPatTaus+process.countPatLeptons+process.countPatPhotons+(process.countPatJets+process.makePatMHTs)*process.countPatJetsAK5PF*process.countPatJetsAK5JPT*process.countPatJetsAK5Track)
...
process.cleanupFilterData = cms.Sequence(process.l1TechFilter+process.physicsDeclared+process.cleanupFilterMC)
...
process.patTriggerSequence = cms.Sequence(process.patTrigger*process.patTriggerMatcher*process.patTriggerEvent)
...
process.makePatJets = cms.Sequence(process.patJetCorrections*(process.jetTracksAssociatorAtVertexAK5Track+process.btaggingAK5Track+(process.jetTracksAssociatorAtVertexAK5JPT+process.btaggingAK5JPT+(process.jetTracksAssociatorAtVertexAK5PF+process.btaggingAK5PF+process.patJetCharge*process.patJetChargeAK5PF)*process.patJetChargeAK5JPT)*process.patJetChargeAK5Track)*process.patJetPartonMatch*process.patJetPartonMatchAK5PF*process.patJetPartonMatchAK5JPT*process.patJetPartonMatchAK5Track*process.patJetGenJetMatch*process.patJetGenJetMatchAK5PF*process.patJetGenJetMatchAK5JPT*process.patJetGenJetMatchAK5Track*process.patJetFlavourId*process.patJets*process.patJetsAK5PF*process.patJetsAK5JPT*process.patJetsAK5Track)
...
process.patDefaultSequencePF = cms.Sequence(process.genForPF2PATSequence+process.patCandidatesPF+process.selectedPatCandidatesPF+process.cleanPatCandidatesPF+process.countPatCandidatesPF)
...
process.TFileService = cms.Service("TFileService",
    fileName = cms.string('PATtuple_MC.root')
)
