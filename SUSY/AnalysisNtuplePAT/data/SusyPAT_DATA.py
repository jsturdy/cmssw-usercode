...
process.source = cms.Source("PoolSource",
    fileNames = cms.untracked.vstring(
        '/store/data/Run2010A/JetMETTau/RECO/Jun9thReReco_v1/0001/DEF726EB-DF74-DF11-96B8-002618943898.root',
        '/store/data/Run2010A/JetMETTau/RECO/Jun9thReReco_v1/0001/D0E14AF9-F974-DF11-A51E-003048678B1C.root',
        '/store/data/Run2010A/JetMETTau/RECO/Jun9thReReco_v1/0001/80515E44-DB74-DF11-AED4-00248C0BE018.root',
        '/store/data/Run2010A/JetMETTau/RECO/Jun9thReReco_v1/0001/64FA42CC-EB74-DF11-8AF1-00261894394D.root',
        '/store/data/Run2010A/JetMETTau/RECO/Jun9thReReco_v1/0001/5014818A-DA74-DF11-8E73-002618943933.root',
        '/store/data/Run2010A/JetMETTau/RECO/Jun9thReReco_v1/0001/34949E78-D474-DF11-ACA9-00261894380A.root',
        '/store/data/Run2010A/JetMETTau/RECO/Jun9thReReco_v1/0001/308125BA-E674-DF11-B5EC-0030486792DE.root',
        '/store/data/Run2010A/JetMETTau/RECO/Jun9thReReco_v1/0000/2E8C0FCA-B174-DF11-AB03-002618FDA263.root'
    ),
...
process.out = cms.OutputModule("PoolOutputModule",
    fileName = cms.untracked.string('SUSYPAT_V9_DATA_jun9th.root'),
...
process.cleanPatCandidatesPF = cms.Sequence(process.cleanPatMuonsPF+process.cleanPatElectronsPF+process.cleanPatPhotonsPF+process.cleanPatTausPF+process.cleanPatPhotonsPF+process.cleanPatJetsPF+process.cleanPatCandidateSummaryPF)
...
#process.cleanupFilterMC = cms.Sequence(process.removePKAM+process.primaryVertexFilter)
...
#process.cleanupFilterData = cms.Sequence(process.l1TechFilter+process.cleanupFilterMC)
...
process.makePatJets = cms.Sequence(process.patJetCorrections*(process.jetTracksAssociatorAtVertexAK5Track+process.btaggingAK5Track+(process.jetTracksAssociatorAtVertexAK5JPT+process.btaggingAK5JPT+(process.jetTracksAssociatorAtVertexAK5PF+process.btaggingAK5PF+process.patJetCharge*process.patJetChargeAK5PF)*process.patJetChargeAK5JPT)*process.patJetChargeAK5Track)*process.patJets*process.patJetsAK5PF*process.patJetsAK5JPT*process.patJetsAK5Track)
...
process.patDefaultSequencePF = cms.Sequence(process.patCandidatesPF+process.selectedPatCandidatesPF+process.cleanPatCandidatesPF+process.countPatCandidatesPF)
...
process.TFileService = cms.Service("TFileService",
    fileName = cms.string('PATtuple_jun9th.root')
)
...
process.GlobalTag = cms.ESSource("PoolDBESSource",
    ...
    globaltag = cms.string('GR_R_37X_V6A::All')
)
